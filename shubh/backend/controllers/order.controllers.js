...
import { sendDeliveryOtpMail, sendDeliveryConfirmationMail } from "../utils/mail.js"
...
export const getMyOrders = async (req, res) => {
    try {
        ...
        console.log('getMyOrders - User role:', user?.role, 'ID:', req.userId)
        ...
        if (user.role == "user") {
            ...
            const filteredOrders = orders.map((order => {
                const ownerShopOrder = order.shopOrders.find(o => o.owner._id == req.userId)
                if (!ownerShopOrder) return null // Skip orders that don't belong to this owner
...
export const verifyDeliveryOtp = async (req, res) => {
    try {
        ...
        try {
            ...
            console.log('Delivery confirmation email failed:', emailError.message)
